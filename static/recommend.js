// Substitute 'YOUR_API_KEY' with the API key you acquired from https://www.themoviedb.org in the code snippet below.
...
function show_details(
  ...
  if (movie_details.poster_path) {
    ...
    poster = "static/movie_default.jpg";
  }
      ...
      if (my_movie.cast.length > 0) {
        ...
        for (var my_cast in top_cast) {
          ...
          if (my_movie.cast[my_cast].profile_path) {
            ...
            cast_profiles.push("static/profile_default.jpg");
          }
        }
      }
    },
    ...
    success: function (recommend) {
      for (var recs in recommend.results) {
        ...
        if (recommend.results[recs].poster_path) {
          ...
          rec_posters.push("static/movie_default.jpg");
        }
      }
    },
    error: function (error) {
